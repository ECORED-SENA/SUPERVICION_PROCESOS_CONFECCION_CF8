...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mt-5 Para realizar una gestión de calidad en la empresa se debe tener en cuenta los siguientes enfoques:      
    ...
    p.mt-5 Para reconocer la gestión en los procesos se debe tener en cuenta el ciclo Deming de la calidad que se puede observar en la figura 19, sobre el cual se construyen los sistemas de gestión, es también conocido como el plan de mejoramiento continuo.
    .row.justify-content-center.align-items-center.mt-5       
      .col-lg-8
        .row.justify-content-center.align-items-center
          .col-lg-12.bg-3.p-5
    ...
    p.mt-5 En los casos de #[b hilos] se analizan propiedades como elasticidad, flexibilidad, durabilidad, resistencia a rotura, tenacidad, solidez al color, uniformidad de tono y grosor. 
    .row.justify-content-center.align-items-center.mt-5
      .col-lg-8
        .row.justify-content-center.align-items-center
          .col-lg-6(data-aos="fade-right")
    ...
    p.mt-5 En los #[b elásticos] es importante realizar pruebas de recuperación de su longitud, teniendo en cuenta el reposo y la tensión ejercida en su elongación. Es importante controlar los desperdicios generados en la producción de los insumos, los cuales inciden en el costo del producto, de allí la importancia del control de los consumos en la planta. El siguiente cuadro muestra pruebas especializadas que se realizan, para evaluar características de algunos insumos:   
    ...
    p.mt-5 En cada una de las actividades que conforman el área de trazo y corte se establecen controles para revisar. Es primordial contar con la trazabilidad de la producción, para ubicar fácilmente cada lote, poder intervenir rápidamente en los productos a corregir y dar respuesta rápida para solucionar el inconveniente. 
    p Los documentos utilizados en el área para controlar el corte, además de la orden de producción, son las inspecciones divididas en procesos según la actividad a ejecutar. Los requisitos para revisar en cada actividad son los siguientes: 
    .row.justify-content-center.align-items-center.mt-5
      .col-lg-10
    ...
    p En estos ensayos o pruebas se analizan las fibras, en cuanto a la cantidad, colorimétrica, peso, composición, cambios dimensionales después del lavado, resistencia a la rotura y al desgarre, elongación y elasticidad de la tela, recuperación a las arrugas, resistencia a la abrasión, solidez al color con el frote, al agua, al planchado, resistencia a la formación de motas (#[i Pilling]), entre otras.

    p En el siguiente cuadro podemos observar algunos ensayos con la norma relacionada que se puede realizar a la prenda. 
    ...
    p.mt-5 Los requisitos que se deben cumplir en la confección y son objetos de control son:
    ...
    p.mt-5 En los terminados se incluyen procesos de planchado, empaque, embalaje y procesos de acabados como lavandería, estampación y bordado. Puede ser que los procesos de acabados pueden desarrollarse de manera externa a la empresa, es decir contratar los servicios, y por lo tanto la importancia de los puntos de control una vez ingresen a la planta, validar las prendas o piezas una vez se realicen los procesos. 

    img.img-t.img-a.my-2(data-aos="zoom-in")(src='@/assets/ilustraciones/img57.png', alt='') 

    p.mt-5 El planchado es la última operación del proceso de producción, es necesario que las personas responsables de la sección tengan los criterios claros para evaluar las prendas que pasarán a las operaciones para la entrega al cliente.

    p.mt-5 Los requisitos para revisar en cada una de las actividades del proceso de acabados son los siguientes: 
